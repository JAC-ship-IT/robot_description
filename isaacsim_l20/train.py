...
def main() -> None:
    ...
    import isaacsim_l20  # noqa: F401  triggers gym.register side effects
    from isaacsim_l20.utils.hydra_utils import hydra_task_config_with_yaml
    from isaacsim_l20.utils.rlgames_utils import (
    ...
    def run(env_cfg, agent_cfg: dict) -> None:
        ...
        if args_cli.capture_viewer:
            ...
            from isaacsim_l20.tasks.simtoolreal.pose_viewer import SimToolRealPoseViewerWrapper
        ...
        if args_cli.wandb_activate:
            from isaacsim_l20.utils.wandb_utils import WandbAlgoObserver

            # WandbAlgoObserver subclasses EnvStatsAlgoObserver — it writes env
            # metrics (reward terms, successes, …) to both TensorBoard and wandb.
            ...
            observers = [WandbAlgoObserver(wandb_cfg)]
        else:
