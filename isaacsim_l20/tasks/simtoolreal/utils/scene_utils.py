...
ARM_JOINT_REGEX = "joint.*"
HAND_JOINT_REGEX = "right_.*"

# Legacy policy order; Isaac Lab tensors are permuted at action/obs boundaries.
JOINT_NAMES_CANONICAL: tuple[str, ...] = (
    "joint1", "joint2", "joint3", "joint4",
    "joint5", "joint6",
    "right_thumb_cmc_yaw","right_thumb_cmc_roll","right_thumb_cmc_pitch",
    "right_thumb_mcp","right_thumb_dip",

    "right_index_mcp_roll","right_index_mcp_pitch","right_index_pip",
    "right_index_dip","right_middle_mcp_roll",

    "right_middle_mcp_pitch","right_middle_pip","right_middle_dip",
    
    "right_ring_mcp_roll","right_ring_mcp_pitch","right_ring_pip",
    "right_ring_dip",

    "right_pinky_mcp_roll","right_pinky_mcp_pitch","right_pinky_pip",
    "right_pinky_dip",
)
assert len(JOINT_NAMES_CANONICAL) == 27

PALM_BODY_NAME = "Link6"
# Merged fingertip bodies land on the DP links in both sims.
FINGERTIP_BODY_REGEX = "right_(index|middle|ring|thumb|pinky)_F80"
FINGERTIP_LINK_NAMES: tuple[str, ...] = (
    "right_thumb_F80", "rright_index_F80", "right_middle_F80",
    "right_ring_F80", "right_pinky_F80",
)


# Per-joint PD gains and dynamics (verified with pretrained checkpoint).
ARM_JOINT_STIFFNESS: dict[str, float] = {
    "joint1": 600.0, "joint2": 600.0, "joint3": 500.0,
    "joint4": 400.0, "joint5": 200.0, "joint6": 200.0,
}
ARM_JOINT_DAMPING: dict[str, float] = {
    "joint1": 27.027026473513512, "joint2": 27.027026473513512,
    "joint3": 24.672186769721083, "joint4": 22.067474708266914,
    "joint5": 9.752538131173853, "joint6": 9.147747263670984,
}

HAND_JOINT_STIFFNESS: dict[str, float] = {
    "right_thumb_cmc_yaw": 13.2, "right_thumb_cmc_roll": 6.95, "right_thumb_cmc_pitch": 4.76,
    "right_thumb_mcp": 6.62, "right_thumb_dip": 0.9,
    "right_index_mcp_roll": 4.76, "right_index_mcp_pitch": 6.62,
    "right_index_pip": 0.9, "right_index_dip": 0.9,
    "right_middle_mcp_roll": 4.76,
    "right_middle_mcp_pitch": 4.76, "right_middle_pip": 6.62,
    "right_middle_dip": 0.9,
    "right_ring_mcp_roll": 4.76, "right_ring_mcp_pitch": 6.62,
    "right_ring_pip": 0.9, "right_ring_dip": 0.9,
    "right_pinky_mcp_roll": 4.76, "right_pinky_mcp_pitch": 6.62,
    "right_pinky_pip": 0.9, "right_pinky_dip": 0.9,
}

HAND_JOINT_DAMPING: dict[str, float] = {
    "right_thumb_cmc_yaw": 0.40845109, "right_thumb_cmc_roll": 0.28676845,
    "right_thumb_cmc_pitch": 0.20394083, "right_thumb_mcp": 0.24044435,
    "right_thumb_dip": 0.04190723,
    "right_index_mcp_roll": 0.20859232, "right_index_mcp_pitch": 0.24595532,
    "right_index_pip": 0.20394083, "right_index_dip": 0.03504461,
    "right_middle_mcp_roll": 0.2085923, "right_middle_mcp_pitch": 0.24595532,
    "right_middle_pip": 0.20394083, "right_middle_dip": 0.03504461,
    "right_ring_mcp_roll": 0.20859226, "right_ring_mcp_pitch": 0.24595528,
    "right_ring_pip": 0.20394083, "right_ring_dip": 0.0350446,
    "right_pinky_mcp_roll": 0.02782345, "right_pinky_mcp_pitch": 0.24595528,
    "right_pinky_pip": 0.20394083, "right_pinky_dip": 0.0350446,
}
HAND_JOINT_ARMATURE: dict[str, float] = {
    "right_thumb_cmc_yaw": 0.0032, "right_thumb_cmc_roll": 0.0032,
    "right_thumb_cmc_pitch": 0.00265, "right_thumb_mcp": 0.0006,
    "right_thumb_dip": 0.0006, "right_index_mcp_roll": 0.00265,
    "right_index_mcp_pitch": 0.00265,
    "right_index_pip": 0.0006, "right_index_dip": 0.00042,
    "right_middle_mcp_roll": 0.00265, "right_middle_mcp_pitch": 0.00265,
    "right_middle_pip": 0.0006, "right_middle_dip": 0.00042,
    "right_ring_mcp_roll": 0.00265, "right_ring_mcp_pitch": 0.00265,
    "right_ring_pip": 0.0006, "right_ring_dip": 0.00042,
    "right_pinky_mcp_roll": 0.00012, "right_pinky_mcp_pitch": 0.00265,
    "right_pinky_pip": 0.0006, "right_pinky_dip": 0.00042,
}
HAND_JOINT_FRICTION: dict[str, float] = {
    "right_thumb_cmc_yaw": 0.132, "lright_thumb_cmc_roll": 0.132,
    "right_thumb_cmc_pitch": 0.07456, "right_thumb_mcp": 0.07456, "right_thumb_dip": 0.01276,
    "right_index_mcp_roll": 0.07456, "right_index_mcp_pitch": 0.07456,
    "right_index_pip": 0.01276, "right_index_dip": 0.00378738,
    "right_middle_mcp_roll": 0.07456, "right_middle_mcp_pitch": 0.07456,
    "right_middle_pip": 0.01276, "right_middle_dip": 0.00378738,
    "right_ring_mcp_roll": 0.07456, "right_ring_mcp_pitch": 0.07456,
    "right_ring_pip": 0.01276, "right_ring_dip": 0.00378738,
    "right_pinky_mcp_roll": 0.012, "right_pinky_mcp_pitch": 0.07456,
    "right_pinky_pip": 0.01276, "right_pinky_dip": 0.00378738,
}

assert len(ARM_JOINT_STIFFNESS) == 6 and len(ARM_JOINT_DAMPING) == 6
assert len(HAND_JOINT_STIFFNESS) == 21 and len(HAND_JOINT_DAMPING) == 21
assert len(HAND_JOINT_ARMATURE) == 21 and len(HAND_JOINT_FRICTION) == 21

# Proven-working default arm pose (isaacsim_conversion/isaacsim_env.py:101-109).
ARM_DEFAULT_JOINT_POS: dict[str, float] = {
    "joint1": 3.20433, "joint2": 0.31698, "joint3": -0.879,
    "joint4": -2.57, "joint5": 4.58791, "joint6": 0.06,
}
...
def _load_adjacent_links_map() -> dict[str, list[str]]:
    ...
    from isaacsim_l20.utils.utils import get_repo_root_dir

    path = get_repo_root_dir() / "isaacsim_l20/tasks/simtoolreal/adjacent_links.py"
    ...
    for src in (
        mod.RIGHT_CR5_LINK_TO_ADJACENT_LINKS,
        mod.LEFT_CR5_LINK_TO_ADJACENT_LINKS,
    ):
...
def setup_scene(env) -> None:
    ...
    env.cfg.terrain.spawn.func(
            env.cfg.terrain.prim_path,
            env.cfg.terrain.spawn,
