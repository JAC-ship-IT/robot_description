...
from isaacsim_l20.utils.interactive_viewer import create_html, make_embedded_robot, make_url_robot

from .utils.scene_utils import JOINT_NAMES_CANONICAL


REPO_ROOT = Path(__file__).resolve().parents[3]
GITHUB_RAW_BASE_MAIN = "https://github.com/JAC-ship-IT/robot_description/main/"
ROBOT_URDF_RELATIVE_PATH = "assets/urdf/dobot_l20/dobot_right_l20.urdf"
