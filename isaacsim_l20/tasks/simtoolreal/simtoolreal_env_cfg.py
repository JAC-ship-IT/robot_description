...
class AssetsCfg:
    robot_urdf: str = (
        "assets/urdf/dobot_l20/dobot_right_l20.urdf"
    )
...
class RewardCfg:
    ...
    dobot_actions_penalty_scale: float = 0.03
...
class SimToolRealEnvCfg(DirectRLEnvCfg):
    ...
    action_space: int = 27  # 6-DOF DOBOT + 21-DOF Linker hand
